...
export function StatCard({ title, value, change, icon: Icon, iconColor, iconBg, suffix }: StatCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-white/[0.03] border border-white/[0.06] p-5 hover:bg-white/[0.05] transition-colors">
      <div className="flex items-start justify-between mb-4">
        <div className={cn("flex items-center justify-center w-10 h-10 rounded-xl", iconBg ?? "bg-indigo-500/15")}>
